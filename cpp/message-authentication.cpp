...
void runGenerate(std::string *key, std::string *data, std::string *result) {
  ...
  StringSource _(*data, true, new HashFilter(mac, new StringSink(*result)));
}
...
void generate(jsi::Runtime &rt, CppArgs *args, std::string *target,
  ...
  if (args->size() < 4)
    throw facebook::jsi::JSError(
        rt, "RNCryptopp: HMAC generate invalid number of arguments");
  ...
  if (!isDataString(args->at(3)))
    throw facebook::jsi::JSError(
        rt, "RNCryptopp: HMAC generate, hash is not a string");
  ...
  if (!invokeWithHash<runGenerateWrapperHMAC>()(hash, &key, &data, target))
    throw facebook::jsi::JSError(
        rt, "RNCryptopp: HMAC generate, invalid hash value");
...
void verify(jsi::Runtime &rt, CppArgs *args, bool *target,
  ...
  if (args->size() < 5)
    throw facebook::jsi::JSError(
        rt, "RNCryptopp: HMAC verify invalid number of arguments");
  ...
  if (!isDataStringOrAB(args->at(2)))
    throw facebook::jsi::JSError(
        rt, "RNCryptopp: HMAC verify, key is not a string or ArrayBuffer");

  if (!isDataString(args->at(3)))
    throw facebook::jsi::JSError(
        rt, "RNCryptopp: HMAC verify, hash is not a string");

  if (!isDataStringOrAB(args->at(4)))
    throw facebook::jsi::JSError(
        rt, "RNCryptopp: HMAC verify, mac is not a string or ArrayBuffer");
  ...
  if (!invokeWithHash<runVerifyWrapperHMAC>()(hash, &key, &dataAndMac, target))
    throw facebook::jsi::JSError(rt,
                                 "RNCryptopp: HMAC verify, invalid hash value");
...
void generate(jsi::Runtime &rt, CppArgs *args, std::string *target,
  ...
  if (args->size() < 4)
    throw facebook::jsi::JSError(
        rt, "RNCryptopp: CMAC generate invalid number of arguments");
  ...
  if (!isDataString(args->at(3)))
    throw facebook::jsi::JSError(
        rt, "RNCryptopp: CMAC generate, cipher is not a string");
  ...
  if (!invokeWithBlockCipher<runGenerateWrapperCMAC>()(cipher, true, true, &key,
                                                       &data, target))
    throw facebook::jsi::JSError(
        rt, "RNCryptopp: CMAC generate, invalid hash value");
...
void verify(jsi::Runtime &rt, CppArgs *args, bool *target,
  ...
  if (args->size() < 5)
    throw facebook::jsi::JSError(
        rt, "RNCryptopp: CMAC verify invalid number of arguments");
  ...
  if (!isDataStringOrAB(args->at(2)))
    throw facebook::jsi::JSError(
        rt, "RNCryptopp: CMAC verify, key is not a string or ArrayBuffer");

  if (!isDataString(args->at(3)))
    throw facebook::jsi::JSError(
        rt, "RNCryptopp: CMAC verify, cipher is not a string");

  if (!isDataStringOrAB(args->at(4)))
    throw facebook::jsi::JSError(
        rt, "RNCryptopp: CMAC verify, mac is not a string or ArrayBuffer");
  ...
  if (!invokeWithBlockCipher<runVerifyWrapperCMAC>()(cipher, true, true, &key,
                                                     &dataAndMac, target))
    throw facebook::jsi::JSError(rt,
                                 "RNCryptopp: CMAC verify, invalid hash value");
